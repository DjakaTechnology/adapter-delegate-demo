...
import id.djaka.adapterdelegatedemo.databinding.ChatReceiverItemBinding
...
class ChatReceiverAdapterDelegate : AdapterDelegate<MessageItem> {
    ...
    override fun onCreateViewHolder(parent: ViewGroup): RecyclerView.ViewHolder {
        return ViewHolder(DataBindingUtil.inflate(LayoutInflater.from(parent.context), R.layout.chat_receiver_item, parent, false))
    }
    ...
    inner class ViewHolder(val binding: ChatReceiverItemBinding): RecyclerView.ViewHolder(binding.root)
